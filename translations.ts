      ...
      projects: [
        {
          ...
          description: 'Desarrollé una secuencia automatizada de correos electrónicos y mensajes en la aplicación para la incorporación de nuevos usuarios usando Zapier e Intercom, reduciendo el esfuerzo manual en un 80%.',
          link: 'https://github.com',
        },
        {
        ...
        {
          title: 'Dashboard de Análisis de CSAT',
          category: 'Reportes',
          image: 'https://images.unsplash.com/photo-1560415755-bd80d06eda60?q=80&w=1374&auto=format&fit=crop',
        ...
        {
          title: 'Base de Conocimiento Interactiva',
        ...
        {
          title: 'Ciclo de Retroalimentación Automatizado',
          category: 'Automatización',
          image: 'https://images.unsplash.com/photo-1587620962725-abab7fe55159?q=80&w=1470&auto=format&fit=crop',
          description: 'Utilicé Make/Integromat para crear un flujo de trabajo que envía automáticamente los resultados de las encuestas de Zendesk a un canal de Slack para el equipo de producto, mejorando los tiempos de respuesta a los comentarios.',
          link: 'https://github.com',
        },
        {
          title: 'Integración de Salesforce y Zendesk',
          category: 'Integración',
          image: 'https://images.unsplash.com/photo-1616486338812-3dadae4b4ace?q=80&w=1470&auto=format&fit=crop',
          description: 'Gestioné la integración entre Salesforce y Zendesk, proporcionando al equipo de soporte una vista de 360 grados del cliente y reduciendo el tiempo promedio de gestión en un 10%.',
          link: 'https://github.com',
        },
      ],
    },
      ...
      jobs: [
        {
          ...
          duties: [
            'Gestioné una cartera de más de 50 cuentas empresariales, asegurando altos niveles de satisfacción y retención.',
            'Desarrollé e implementé planes y estrategias de éxito del cliente.',
            'Creé automatizaciones para procesos internos y comunicaciones con los clientes.',
            'Actué como defensor del cliente, proporcionando retroalimentación a los equipos de producto e ingeniería.',
          ],
        },
        {
          ...
          location: 'Austin, TX',
          duties: [
            'Proporcioné soporte técnico de nivel 2 para un producto SaaS.',
            'Redacté artículos de la base de conocimientos y documentación técnica.',
            'Colaboré con ingeniería para resolver problemas técnicos complejos.',
            'Alcancé una calificación de satisfacción del cliente del 95%.',
          ],
        },
        {
          role: 'Defensor del Cliente',
          company: 'Supportify Ltd.',
          date: '2016 - 2018',
          location: 'Remoto',
          duties: [
            'Actué como el principal punto de contacto para un conjunto dedicado de clientes.',
            'Recopilé comentarios de los clientes para informar el desarrollo de productos.',
            'Mejoré la retención de clientes en un 15% a través de un compromiso proactivo.',
            'Capacité a los clientes sobre nuevas funciones y mejores prácticas.',
          ],
        },
        {
          role: 'Agente de Soporte Junior',
          company: 'HelpDesk Corp.',
          date: '2015 - 2016',
          location: 'Nueva York, NY',
          duties: [
            'Resolví consultas de clientes a través de soporte por correo electrónico y chat.',
            'Mantuve un alto nivel de satisfacción del cliente.',
            'Documenté y escalé problemas técnicos al equipo de desarrollo.',
